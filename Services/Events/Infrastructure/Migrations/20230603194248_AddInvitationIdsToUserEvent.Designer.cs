...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230603194248_AddInvitationIdsToUserEvent")]
    partial class AddInvitationIdsToUserEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApplicationCore.Models.Entities.UserEvent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a8f34e98-d649-4903-b0ac-e6e4f903f2fc"),
                            AdditionalInfo = "test additionalInfo from seed",
                            Category = "test category from seed",
                            Date = new DateTime(2023, 6, 3, 19, 42, 48, 417, DateTimeKind.Utc).AddTicks(8114),
                            Description = "test description from seed",
                            Done = false,
                            EndTime = new DateTime(2023, 6, 3, 21, 42, 48, 417, DateTimeKind.Utc).AddTicks(8094),
                            HasRecurrency = true,
                            ImageUrl = "test image url from seed",
                            InvitationIds = "[]",
                            LastDate = new DateTime(2023, 6, 3, 19, 42, 48, 417, DateTimeKind.Utc).AddTicks(8115),
                            Name = "Test name from seed",
                            Place = "test place from seed",
                            StartTime = new DateTime(2023, 6, 3, 19, 42, 48, 417, DateTimeKind.Utc).AddTicks(8091)
                        });
                });
